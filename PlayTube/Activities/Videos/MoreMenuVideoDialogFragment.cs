    ...
    public class MoreMenuVideoDialogFragment : BottomSheetDialogFragment, MaterialDialog.IListCallback, MaterialDialog.ISingleButtonCallback
    {
        ...
        private void ReportCopyRightLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                if (UserDetails.IsLogin)
                {
                    ...
                    {
                        MaterialDialog dialog = new MaterialDialog.Builder(Activity).Theme(AppTools.IsTabDark() ? MaterialDialogsTheme.Dark : MaterialDialogsTheme.Light)
        ...
        private void QualityLayoutOnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                var dialogList = new MaterialDialog.Builder(Context).Theme(AppTools.IsTabDark() ? MaterialDialogsTheme.Dark : MaterialDialogsTheme.Light);
