            ...
            try
            {
                ...
                switch (IsOwner)
                {
                    case false:
                        ...
                        //VideoId = LiveStreamViewerObject.VideoId;
                        break;
                }
            ...
            try
            {
                ...
                switch (IsOwner)
                {
                    case true:
                    {
                        if (PostObject != null)
                        {
                            GlideImageLoader.LoadImage(this, PostObject.Owner?.OwnerClass?.Avatar, BgAvatar, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
                            GlideImageLoader.LoadImage(this, PostObject.Owner?.OwnerClass?.Avatar, StreamRateLevel, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                        }
                    ...
                    default:
                    {
                        ...
                        {
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Owner?.OwnerClass?.Avatar, BgAvatar, ImageStyle.CenterCrop, ImagePlaceholders.DrawableUser);
                            GlideImageLoader.LoadImage(this, LiveStreamViewerObject.Owner?.OwnerClass?.Avatar, StreamRateLevel, ImageStyle.CircleCrop, ImagePlaceholders.DrawableUser);
                        }
