...
{
    public class SearchFragment : Fragment, TextView.IOnEditorActionListener, MaterialDialog.IListCallback
    { 
        ...
        private void FilterButtonOnClick(object sender, EventArgs e)
        {
            try
            {
                var dialogList = new MaterialDialog.Builder(Activity).Theme(AppTools.IsTabDark() ? MaterialDialogsTheme.Dark : MaterialDialogsTheme.Light);
